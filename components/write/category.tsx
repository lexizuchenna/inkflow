  ...
  return (
    <div className="space-y-3 relative" ref={containerRef}>
      ...
      {isOpen && search.length > 0 && (
        <div className="absolute top-full left-0 w-full mt-2 bg-background border border-border rounded-2xl shadow-2xl p-2 z-[60] animate-in fade-in slide-in-from-top-2">
          {isLoading && (
          ...
          {suggestions.map((cat) => (
            <button
              ...
              className="w-full text-left px-4 py-2.5 text-sm rounded-xl hover:bg-foreground/5 transition-colors flex items-center justify-between"
            >
              {cat}
